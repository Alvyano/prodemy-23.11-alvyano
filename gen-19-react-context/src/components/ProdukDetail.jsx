...
function ProdukDetail(props) {
    ...
    const AddToCart = () => {
        ...
        const isExist = existOnCart(dataCart, id);
        if (!isExist) {
            setDataCart([...dataCart, {
                id: id
            }])
            alert(`Produk ${mainData?.nama} Ditambahkan`)
        }
    }
    ...
    return (
        ...
        <div className='flex min-h-screen gap-x-10 flex-cols-2 px-20 py-32'>
          ...
          <div className='w-1/2 px-3'>
            ...
            <Button onClick={() => AddToCart()} className="bg-white hover:bg-amber-600 text-black hover:text-white hover:border-gray-800">
                Add To Whistlist
              </Button>
