...
function ProductCard(props) {
  ...
  return (
    <section className='bg-white rounded-lg border p-4 cursor-pointer shadow-md hover:shadow-md transition-all duration-300 hover:scale-105 transition-all duration-300' {...props} onClick={() => goToProductPage(id)}>
