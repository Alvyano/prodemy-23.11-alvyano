...
import closeIcon from "../assets/img/icon-close-white.svg";
import prevIcon from "../assets/img/icon-previous.svg";
    ...
    <main>
      <div className="main-wrapper flex flex-col md:flex-row md:px-[200px] md:py-[100px] relative">
        ...
        <div className="description p-6 md:basis-1/2 md:py-[40px]">
          ...
          <h1 className="text-3xl md:text-2xl capitalize font-[600]">
            Kopi Susu Gula Aren
          </h1>
          <p className="hidden md:block text-darkGrayishBlue my-10 leading-7">
          Kopi susu gula aren adalah minuman kopi khas Indonesia yang memadukan kekuatan dan keharuman kopi dengan kelembutan dan kekentalan susu, ditambah dengan manisnya gula aren.<br /><br></br>
          Minuman ini sering disajikan dalam gelas atau cangkir yang khas, dan rasanya sangat disukai oleh pecinta kopi yang menginginkan kombinasi unik dari rasa pahit kopi,<br />
          manisnya gula aren, dan kelembutan susu. 
          </p>
         

          <div className="price flex items-center">
            <span className="text-3xl font-[700] mr-4">Rp.{fixedPrice}</span>
