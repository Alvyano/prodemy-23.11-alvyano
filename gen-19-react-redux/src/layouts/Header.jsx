  ...
  return (
    <div>
      <div className='flex place-content-between text-lg flex-row py-4 px-10 text-black'>
        ...
        <Link to={"/cart"}>
          <button className="bg-amber-500 text-black font-sm px-3 py-1 hover:text-white rounded-md">Wishlist</button>
         </Link> 
          <Link to="/admin">
            <button className="bg-amber-500 text-black  px-3 py-1 hover:text-white rounded-md">Admin</button>
          </Link>
        </div>
      </div>
      <div className='pb-1'>
